...
ObjModel::MaterialInfo::~MaterialInfo(void)
{
	if (texture != NULL)
		delete texture;
}
...
ObjModel::Texture::Texture(const std::string& file)
{
	...
	unsigned char* imgData = stbi_load(file.c_str(), &textureWidth, &textureHeight, &bpp, 4);
